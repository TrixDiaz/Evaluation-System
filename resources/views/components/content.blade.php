<section class="bg-white dark:border-outline-dark dark:bg-surface-dark-alt rounded-4xl m-4">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div class="hover:bg-primary hover:cursor-pointer hover:rounded-2xl p-5">
            ...
            <div class="border border-primary border-1 hover:bg-primary rounded-2xl hover:bg-primary hover:cursor-pointer hover:rounded-2xl p-5">
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
